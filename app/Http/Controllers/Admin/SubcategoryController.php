...
class SubcategoryController extends Controller
{
    ...
    public function store(Request $request, Category $category)
    {
        ...
        {
            $request->merge(['image' => Upload::uploadImage($request->main_image, 'categories' , $request->name_ar)]);
        }

        $validator = Validator::make($request->all(), ['name_ar' => 'required', 'name_en' => 'required', 'description_ar' => 'required' , 'description_en' => 'required']);
    ...
    {   
        return view('admin.subcategories.edit')->withCategory($category)->withSubcategory($subcategory)->withOptions(Option::all())->withCategoryOptionsIds($subcategory->options->pluck('id')->toArray());
    }
