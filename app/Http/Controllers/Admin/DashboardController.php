...
class DashboardController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->sortLabels = Category::whereCategoryId(Null)->pluck('name_ar');
    }
    ...
    public function index()
    {
       ...
       $ProductsInYearChart->height(200);
          ...
          $orders = Order::whereNull('read_at')->latest()->take(10)->get();

        return view('admin.dashboard', compact('productCount', 'orderCount', 'clientsCount', 'vendorsCount', 'OrdersInYearChart', 'countCategoryChart' ,'ProductsInYearChart' , 'postsByMonthChartTwo', 'users', 'admins', 'products','orders'));
