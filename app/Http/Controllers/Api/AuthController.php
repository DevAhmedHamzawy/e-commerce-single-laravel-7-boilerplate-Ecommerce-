...
class AuthController extends Controller
{
    ...
    {
        return response()->json(User::whereId($request->user()->id)->with('shippingAddresses', 'orders', 'orders.items', 'orders.items.product', 'favourites', 'favourites.product')->firstOrFail());
    }
}