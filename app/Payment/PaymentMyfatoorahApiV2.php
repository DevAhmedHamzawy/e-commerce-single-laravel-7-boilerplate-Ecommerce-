...
use App\Payment\MyfatoorahApiV2;
use Exception;
...
//-----------------------------------------------------------------------------------------------------------------------------------------
     ...
     * @return array
     */
    protected function excutePayment($orderId, $curlData, $gatewayId) {
        ...
        // NEVER REMOVE IT OTHERWISE THE RETURN DATA WILL NOT FUCKING RETURN
        header('Location: '.$json->Data->PaymentURL); die;
