                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12" id="the_icon">
                            <img src="{{ asset('public/admin/panel/img/upload.png') }}" class="the_image_changing"  onclick="document.getElementById('image').click()" alt="Cinque Terre">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="show" id="inlineRadio1" value="blocks" checked>
                                    <label class="form-check-label" for="inlineRadio1">blocks</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="show" id="inlineRadio2" value="tabs">
