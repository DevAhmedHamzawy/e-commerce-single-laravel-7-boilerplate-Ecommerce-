                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-md-12" id="the_icon">
                                        <img src="{{ url('admin/panel/img/upload.png') }}" style="width:60px;height:60px;margin: 16px 45%;background-color: black;" class="the_image_changing" onclick="document.getElementById('image').click()" alt="Cinque Terre">
