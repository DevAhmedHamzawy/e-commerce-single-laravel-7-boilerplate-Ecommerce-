  ...
  <div class="container-fluid" style="margin-left: 2%;">
    ...
    <div class="row" style="margin-left: 6%;margin-right: 4%;">
        <ul class="nav nav-tabs menu_tab" id="myTab" role="tablist" style="justify-content: flex-end;border-bottom: solid 2px gray;margin-top: 28px;">
          ...
          <li class="nav-item"><a class="nav-link" id="lunch-one-tab" data-toggle="tab" href="#lunchone" role="tab" aria-selected="false">Lunch</a></li>
          <li class="nav-item"><a class="nav-link" id="dinner-one-tab" data-toggle="tab" href="#dinnerone" role="tab" aria-selected="true">Dinner</a></li>
        </ul>
    </div>
